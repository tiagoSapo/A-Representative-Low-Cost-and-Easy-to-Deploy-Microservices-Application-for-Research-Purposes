...
data <- read.csv("/Users/tiago/Desktop/nova experiencia 20DEZ/store-1h-1000-4F-4P/products/nw-out.csv")
theme_set(
  theme_classic() +
...
ggsave("/Users/tiago/Desktop/nova experiencia 20DEZ/store-1h-1000-4F-4P/products/nw-out.pdf", plot = p, width = 6, height = 3.5, units = "in", dpi = 300)
print(p)
