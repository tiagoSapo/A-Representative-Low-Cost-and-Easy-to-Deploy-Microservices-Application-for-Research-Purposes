...
data <- read.csv("/Users/tiago/Desktop/nova experiencia 20DEZ/store-1h-1000-4F-4P/front/nw-out.csv")
theme_set(
  theme_classic() +
...
ggsave("/Users/tiago/Desktop/nova experiencia 20DEZ/store-1h-1000-4F-4P/front/nw-out.pdf", plot = p, width = 6, height = 4.75, units = "in", dpi = 300)
print(p)
